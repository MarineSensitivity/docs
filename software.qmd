...
6. **applications** — interactive Shiny apps (`mapgl`, `mapsp`, …) that combine the raster tile factory with static [PMTiles](https://protomaps.com/docs/pmtiles/) vector layers and live-pushed choropleth paint rules;
