...
The **Scores** application ([app.marinesensitivity.org/scores](https://shiny.marinesensitivity.org/scores/)) is the primary interactive tool for exploring composite marine sensitivity scores across BOEM Program Areas. It enables users to visualize extinction risk weighted species presence at multiple spatial resolutions, with integrated flower plot and treemap summaries.
