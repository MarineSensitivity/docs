...
The merged model is the derived output of the model merging pipeline (see @sec-model-merging). For each of the 16,158 valid species, cell values are computed as:
