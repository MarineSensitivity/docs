...
1. **Species** — by taxonomic category (bird, coral, fish, invertebrate, mammal, reptile/turtle): extinction risk weighted species distribution models across `r n_fmt(mst_stats$valid_species)` valid species (see @sec-data-sources, @sec-extinction-risk)
